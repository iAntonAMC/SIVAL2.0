...
<head>
    ...
    <title>UI- VISITORS INSERT</title>
        ...
        <div class="col s12 m4 offset-m4">
          <div class="card">
            <div class="card-action red lighten-1 white-text">
              <h3>Solicitud de Visitante</h3>
            </div>
            <div class="card-content">
              <div class="form field">
                <form action="../../controllers/visitors/create_visitor.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col s6">
                  <div class="form field">
                    <input class="s6 waves-effect waves-light btn-large green" type="submit" style="width: 100%" title="Enviar Solicitud">
                  </div>
                  </div>
                </div>
