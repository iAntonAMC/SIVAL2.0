...
sdk = credentials.Certificate("sival-666-firebase-adminsdk-d4rix-c1f1ffa623.json")
firebase_admin.initialize_app(sdk, {'databaseURL':'https://sival-666-default-rtdb.firebaseio.com/'})
